...
class ExpenseItem extends React.Component {
  ...
  render() {
    if (this.props.isEditing === true) {
      return (
        <div>
          <ExpenseForm name="update" id={this.props.id} buttonText="Update" categoryId={this.props.categoryId}></ExpenseForm>
          <button onClick={this.toggleOffEdit} id={this.props.id}>Cancel</button>
        </div>
      )
    }
    return (
